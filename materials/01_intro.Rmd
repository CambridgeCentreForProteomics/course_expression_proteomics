...
[Adapting this workflow to label-free proteomics](./10_lfq_vs_tmt.html) for 
more details.
...
could be adapted to [label-free data](./10_lfq_vs_tmt.html) or 
[data processed using MaxQuant](./08_maxquant_notes.html) rather than Proteome Discoverer.
