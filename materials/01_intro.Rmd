...
TMTplexes) containing 6 (TMT6plex(TM)), 10 (TMT10plex(TM)), 16 (TMTpro
16plex(TM)), 18 (TMTpro 18plex(TM)) or 32 (TMTpro 32plex(TM)) TMT labels.
Further, kits can be combined to multiplex up to 35 samples. The isobaric nature
of TMT reagents means that all of the labels within a TMTplex have the same
overall mass. However, they differ in how this mass is distributed between their
two variable regions - the **reporter** and **mass normaliser**. The structure
of a TMT label is shown below in @fig-tmt-structure.
