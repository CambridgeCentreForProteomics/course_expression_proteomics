...
We now have three additional columns, one per contrast, called `sig_G1_M`, `sig_M_Des`,
...
given contrast after applying global p-value adjustment.
...
```{r, include=FALSE}
## Save results
save(M_Desynch_results, all_proteins, file = here("course_files/preprocessed/lesson06.rda"))
```
