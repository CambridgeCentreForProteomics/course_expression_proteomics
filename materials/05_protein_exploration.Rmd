...
If we look at the names of the columns within our "`log_peptides"` and
`"log_proteins"` experimental assays we see that there is a column called `.n`. 
...
in `"log_peptides"` tells us how many PSMs we have in support of each peptide,
and in `"log_proteins"` how many peptidescwe have in support of each master protein.
