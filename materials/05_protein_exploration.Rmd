...
Let's now calculate summary statistics to find the median number of PSMs.
...
(i) We have one instance which has 223 PSMs for one given protein.
...
(iii) The median number of PSMs is 2.
