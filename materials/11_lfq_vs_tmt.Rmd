...
table1 <- data.frame("Data processing stage" = c("Import", "Data cleaning", "Quality control filtering",
                     ...
                     "TMT" = c("Import PSM-level data", 
                               ...
                               "Log",
                               "Summarisation using robustSummary or sum method",
...
structure has not beendrastically altered (e.g., by checking summary statistics or 
...
a peptide-level effect. Thus `robustSummary` estimates the protein-level abundances within the modeling. 
This modeling-based approach to protein summarisation can handle relatively sparse data as
