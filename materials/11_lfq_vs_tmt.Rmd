...
table1 <- data.frame("Data processing stage" = c("Import", "Data cleaning", "Quality control filtering",
                     ...
                     "TMT" = c("Import PSM-level data", 
                               ...
                               "Additional thresholds on reporter ion signal-to-noise ratio,
                               co-isolation interference and SPS mass matches",
                     ...
                     "Label-free" = c("Import PSM- or peptide-level data, depending on software output of MBRs",
                                      ...
                                      "Higher proportion of missing values - impute at lowest data level or 
                                      use robustSummary aggregation",
                                      "Log2 transformation",
...
knitr::kable(table1, 
             ...
             caption = "Main differences between processing workflow for TMT and label-free quantitative proteomics data prior to differential expression analyses")
```
