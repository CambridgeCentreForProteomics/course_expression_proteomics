...
* Know the difference between MS2- and MS3-based quantitation
...
```{r, tmt_quant_fig, echo = FALSE, fig.cap = "Relative peptide quantitation using TMT labels. Image modified from Thermo Fisher Scientific.", fig.align = "center", out.width = "50%"}
