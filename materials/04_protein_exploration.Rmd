...
There are many ways we can visualise PSM support.
...
As we have fewer proteins with a larger number of PSMs what we might want to
do to helpo visualise the PSM
...
We have one instance which has 413 PSMs for one given protein. 
