...
### DIA data for subcellular proteomics lessons

For the DIA-NN processing and correlation profiling lessons (Lessons 12-13),
additional data can be downloaded from Zenodo:
[https://zenodo.org/records/15537457](https://zenodo.org/records/15537457)

This data corresponds to the DIA proteomics workflow described in the appendix 
of the F1000Research article "A Bioconductor workflow for processing, evaluating, 
and interpreting expression proteomics data".

The tutorial notebooks can also be run using the simulated data provided within 
the notebooks themselves if you do not wish to download the real data.
...
For some advanced exercises in the DIA and correlation profiling lessons, you may 
want to install these optional packages:
